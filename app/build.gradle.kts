...
android {
    ...
    defaultConfig {
        ...
        val key =
            property("apikey")?.toString() ?: error("You should add apikey to gradle.properties")
...
dependencies {
    ...
    implementation(libs.bundles.mvikotlin.bundle)
    implementation(libs.bundles.decompose.bundle)
