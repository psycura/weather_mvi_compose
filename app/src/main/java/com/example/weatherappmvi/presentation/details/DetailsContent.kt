...
import com.example.weatherappmvi.presentation.extensions.formattedFullDate
import com.example.weatherappmvi.presentation.extensions.formattedShortDayOfWeek
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onFavoriteClick = { component.onClickAddFavorite() }
            )
        }
    ) { padding ->
        Box(
            ...
            when (val forecastState = state.forecastState) {
                ...
                is DetailsStore.State.ForecastState.Loaded -> Forecast(forecastState.forecast)
...
private fun Forecast(forecast: Forecast) {
    Column(
        ...
        Row(
            ...
            Text(
                text = forecast.currentWeather.temperature.tempToFormatedString(),
...
@Composable
private fun AnimatedUpcomingWeather(modifier: Modifier = Modifier, upcoming: List<Weather>) {
...
private fun RowScope.SmallWeatherCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(weather.temperature.tempToFormatedString())
            GlideImage(
